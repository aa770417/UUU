...
; (function (root, factory) {
    ...
    FormValidator.prototype = {
        ...
        texts: {
            ...
            number_min: '最低月薪需大於24,000',
            number_max: '薪資不能超過1,000,000',
            url: 'invalid URL',
            number: '請輸入數字',
        ...
        tests: {
            ...
            text: function (field, data) {
                ...
                if (data.validateWords) {
                    ...
                    if (words.length < data.validateWords || !wordsLength(1))
            ...
            ctl00$ContentPlaceHolder1$txtSalary: function (field, data) {
                var a = data.value;
