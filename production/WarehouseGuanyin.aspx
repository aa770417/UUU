...
<script runat="server">
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("~/production/WarehouseGuanyin.aspx");
    }
    ...
    protected void Button3_Click(object sender, EventArgs e)
    {
        ...
        foreach (var item in Id)
        {
            Order.TurnOrder(int.Parse(item.ToString()));
        }
        Response.Redirect("~/production/WarehouseGuanyin.aspx");
    }
    ...
    protected void Page_PreLoad(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            Repeater1.DataSource = Order.FindOrderG();
            Repeater1.DataBind();
        }
    }
</script>
    ...
    <div class="right_col" role="main">
        <div class="page-title">
            ...
            <div class="title_left">
                <h3 style="font-size: 48px">觀音倉</h3>
            </div>
            <%--空間剩餘表--%>
            <div class="project_progress title_right">
                ...
                <span id="bar1Text">0% Complete</span>
            </div>
        </div>
        ...
        <div class="col-md-12 ">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Guanyin Warehouse</h2>
                    <div class="input-group-btn" style="text-align-last: right">
                        <button type="button" class="btn btn-secondary dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                            觀音倉<span class="caret"></span>
                        </button>
                        <div style="text-align-last: center">
                            <ul class="dropdown-menu dropdown-menu-left" role="menu">
                                <li><a class="dropdown-item close" href="/production/Warehouse.aspx">倉庫管理</a></li>
                ...
                <div style="text-align-last: right">
                    ...
                    <a href="#" class="btn btn-info btn-xs" data-toggle="modal" data-target="#transfer"><i class="fa fa-repeat"></i>轉移</a>
                    <a href="#" class="btn btn-danger btn-xs" onclick="ifcheck()" data-toggle="modal" data-target="#myModal"><i class="fa fa-trash-o"></i>出倉</a>
                </div>
                <!--數據呈現-->
    ...
    <div class="modal" id="transfer">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <!-- Modal footer -->
                <div class="modal-footer">
                    <%--<button id="btnT" type="button" class="btn btn-primary" onclick="">確定</button>--%>
                    <asp:Button ID="Button3" runat="server" CssClass="btn btn-primary btn-xs" Text="確定" OnClick="Button3_Click" />
                    <button type="button" class="btn btn-danger" data-dismiss="modal">取消</button>
                </div>
