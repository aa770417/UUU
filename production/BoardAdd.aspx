...
<script runat="server">
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        TomBoardUtility.AddBoard(b);
        Response.Redirect("~/production/TomDefault.aspx");
    }
    protected void Button2_Click(object sender, EventArgs e)
    {
        //demo用
        textSubj.Text = "防堵疫情擴散！東琉離島海運「實名制」登船 明年6月上路";
        ...
        <div class="">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 ">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2><span style="font-size: 1em; color: blue;"><i class="fas fa-chalkboard-teacher"></i></span>新增佈告欄</h2>
                        ...
                        <div class="x_content">
                            ...
                            <div id="demo-form2" class="form-horizontal form-label-left">
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        <asp:TextBox ID="textContent" name="textContent" runat="server" TextMode="MultiLine"  Height="400px" Width="600px" ValidateRequestMode="Disabled"></asp:TextBox>
                                ...
                                <div class="item form-group">
                                    <div class="col-md-6 col-sm-6 offset-md-3">
                                       <asp:HyperLink ID="HyperLink1" runat="server" CssClass="btn btn-primary" NavigateUrl="~/production/TomDefault.aspx">返回</asp:HyperLink>
                                        ...
                                        <asp:Button ID="Button1" runat="server" Text="新增" type="submit" CssClass="btn btn-success" OnClick="Button1_Click" />
