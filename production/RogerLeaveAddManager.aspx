...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            HRCEName.DataSource = HRUtility.GetDepartmentNameByDIDNoAll(emp.DepartmentID);
            HRCEName.DataTextField = "Value";
            HRCEName.DataValueField = "Key";
            HRCEName.DataBind();
            HRCEName.SelectedIndex = 0;
    ...
    protected void HRCEName_SelectedIndexChanged(object sender, EventArgs e)
    {
        HRCEID.Value = HRCEName.SelectedValue;
    }
</script>
        ...
        <div class="">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 ">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Proxy Leave <small>部門代請假系統</small></h2>
                        ...
                        <div class="x_content">
                            ...
                            <div id="demo-form2" class="form-horizontal form-label-left">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        <asp:DropDownList CssClass="form-control input-md" ID="HRCEName" runat="server" OnSelectedIndexChanged="HRCEName_SelectedIndexChanged" AutoPostBack="True"></asp:DropDownList>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        ...
                                        <asp:DropDownList ID="TypeOfLeave" runat="server" CssClass="select2_single form-control">
                                            <asp:ListItem Value="OfficialLeave">公假</asp:ListItem>
                                            <asp:ListItem Value="PersonalLeave">事假</asp:ListItem>
                                            <asp:ListItem Value="SickLeave">病假</asp:ListItem>
                                            <asp:ListItem Value="MenstruationLeave">生理假</asp:ListItem>
                                            <asp:ListItem Value="MMLeave">婚產假</asp:ListItem>
                                            <asp:ListItem Value="BereavementLeave">喪假</asp:ListItem>
                                        </asp:DropDownList>
