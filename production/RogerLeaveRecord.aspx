...
<script runat="server">
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            DDLYear.DataSource = HRUtility.GetYearFromLeaveByEID(emp.EmployeeID);
            DDLYear.DataTextField = "Value";
            DDLYear.DataValueField = "Key";
            DDLYear.DataBind();
            DDLYear.SelectedIndex = 0;

            DDLMonth.DataSource = HRUtility.GetMonthFromLeaveByEID(emp.EmployeeID);
            ...
            Repeater1.DataSource = HRUtility.GetPersonalLeaveRecordWithTime(emp.EmployeeID, now.Substring(0, 4), now.Substring(5, 2));
            Repeater1.DataBind();
    ...
    protected void DDLYear_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        Repeater1.DataSource = HRUtility.GetPersonalLeaveRecordWithTime(emp.EmployeeID, DDLYear.SelectedValue, DDLMonth.SelectedValue);
        Repeater1.DataBind();
    }
        ...
        <div class="">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 ">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Personal Leave Record <small>個人請假紀錄</small></h2>
