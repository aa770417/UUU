...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Page.IsPostBack == false)
        {
            ...
            txtWorkDate.Value = wsr.WorkDate.ToShortDateString();
        }
    }
    ...
    protected void btnEdit_Click(object sender, EventArgs e)
    {
        WorkShiftRecord wsRecord = new WorkShiftRecord()
        {
            ...
            WorkDate = Convert.ToDateTime(txtWorkDate.Value)
        };
        bool editOk = PeterHsuUtilities.EditWorkShiftRecord(wsRecord);
        ...
        {
            this.ClientScript.RegisterClientScriptBlock(this.GetType(), "Close", "alert('修改失敗');", true);
        }
                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form class="form-label-left input_mask" runat="server">
                                ...
                                <div class="form-group row">
                                    <label class="col-form-label col-md-3 col-sm-3 text-right">
                                        工作日 <span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6  form-group has-feedback">
                                        <input id="txtWorkDate" class="date-picker form-control" required="required" type="text" onfocus="this.type='date'" onclick="this.type='date'" onblur="this.type='text'"  onmouseout="timeFunctionLong(this)" runat="server" />
                                ...
                                <div class="form-group row">
                                    <div class="col-md-9 col-sm-9  offset-md-3">
                                        ...
                                        <asp:Button ID="btnEdit" CssClass="btn btn-success" runat="server" Text="修改" OnClick="btnEdit_Click"  /> 
                                    </div>
                                </div>
